...
func (x *Article) GetContents() string {
	if x != nil {
		return x.Contents
	}
	return ""
...
func (x *ArticleList) GetArticle() []*Article {
	if x != nil {
		return x.Article
	}
	return nil
...
var file_article_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	...
	0x09, 0x52, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x39, 0x0a, 0x0a, 0x63,
	...
	,
}
...
var file_article_proto_goTypes = []interface{}{
	...
	(*ArticleList)(nil),           // 1: ArticleList
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),         // 3: google.protobuf.Empty
}
var file_article_proto_depIdxs = []int32{
	2, // 0: Article.created_at:type_name -> google.protobuf.Timestamp
	2, // 1: Article.updated_at:type_name -> google.protobuf.Timestamp
	0, // 2: ArticleList.article:type_name -> Article
	3, // 3: ArticleService.GetList:input_type -> google.protobuf.Empty
	1, // 4: ArticleService.GetList:output_type -> ArticleList
...
type ArticleServiceClient interface {
	GetList(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ArticleList, error)
}
...
func (c *articleServiceClient) GetList(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ArticleList, error) {
	out := new(ArticleList)
	err := c.cc.Invoke(ctx, "/ArticleService/GetList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArticleServiceServer interface {
	GetList(context.Context, *emptypb.Empty) (*ArticleList, error)
}
...
func (*UnimplementedArticleServiceServer) GetList(context.Context, *emptypb.Empty) (*ArticleList, error) {
...
func _ArticleService_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ArticleService/GetList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArticleServiceServer).GetList(ctx, req.(*emptypb.Empty))
	}
